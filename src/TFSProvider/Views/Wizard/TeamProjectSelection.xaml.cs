...
namespace TFSProvider
{
    ...
    /// </summary>
    public partial class TeamProjectSelection : System.Windows.Controls.UserControl
    {
        public TeamProjectSelection(ProjectSelectionPage dataContext)
        {
            InitializeComponent();
        ...
        {
            ((ProjectSelectionPage)this.DataContext).GetTFSConfiguration();
        }
    }
}
